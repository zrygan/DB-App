...
<%@page import="com.source.HospitalDB.DAO.PatientsDAO" %>
<%@page import="com.source.HospitalDB.Classes.Patients" %>
...
<html>
    ...
    <body>
        <% 
            ...
            int patient_id = PatientsDAO.getPatientId_NameAndBday(patient_name, birthDate);
            
            String doctor_name = request.getParameter("doctor_name") != null ? request.getParameter("doctor_name") : "Not Provided";
            int doctor_id = DoctorsDAO.getDoctorId_name(doctor_name);
